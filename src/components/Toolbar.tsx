    ...
    >
      ...
      >
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 h-[26px] rounded-[5px] text-[11px] text-faint/60 hover:text-faint hover:bg-raised transition-colors bg-transparent border-0 cursor-pointer select-none whitespace-nowrap"
        >
